...
class IndicatorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create indicator" do
    assert_difference('Indicator.count') do
      post indicators_url, params: { indicator: { description: @indicator.description, impact: @indicator.impact, name: @indicator.name } }
    end
  ...
  test "should update indicator" do
    patch indicator_url(@indicator), params: { indicator: { description: @indicator.description, impact: @indicator.impact, name: @indicator.name } }
